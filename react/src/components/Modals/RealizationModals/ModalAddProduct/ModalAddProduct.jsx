...
import cl from './ModalAddProduct.module.css'
...
const ModalAddProduct = ({changeModal}) => {
    ...
    const item = Products.current_product_instance
                ...
                <div style={{display: 'flex', justifyContent: 'center'}}>
                    <Button
                        ...
                        onClick={() => {
                            formNotValid()
                            if (formValid) {
                                Products.setChoicedProductItem({
                                    product: Products.current_product_instance.pk,
                                    color: product_color.value.pk,
                                    pairs: product_qty.value,
                                    packages: package_qty.value,
                                    bags: bag_qty.value,
                                    released: sum.value,
                                    product_images: Products.current_product_instance.product_images,
                                    text: {
                                        article: Products.current_product_instance.article_number,
