...
import PartnersPage from "../../../../store/PartnersPage";

const PartnersModalAddPartner = ({changeModal}) => {
...
export default PartnersModalAddPartner;