...
import cl from './ProductionModalProducts.module.css'
...
import CartSelect from "../../../Carts/ProductionCarts/SelectCart/CartSelect";
import CartChoiced from "../../../Carts/ProductionCarts/ChoicedCart/CartChoiced";

const ProductionModalProducts = ({changeModal, changeModalAddProduct, changeProduct}) => {
                ...
                <div className={cl.modal_header}>
                    <div className={cl.header_buttons}>
                        ...
                        <div className={headerChoicedStyle.join(' ')}  onClick={() => toggle()}>
                            Выбранные: {ProductionItems.items.length}
                        </div>
                    </div>
                        ...
                        <div className={cl.modal_content_inner}>
                            {Products.items ?
                                Products.items.map(item =>
                                    <CartSelect item={item} key={item.id} onClick={changeModalAddProduct}/>
                                )
                                :
                                ''
                            }
...
export default observer(ProductionModalProducts);