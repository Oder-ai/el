...
import cl from './StoreModalProducts.module.css'
import ModalItemSelect from "../../../Carts/StoreCarts/ModalItemSelect/ModalItemSelect";
...
const StoreModalProducts = ({changeModal, changeModalAddProduct, changeProduct}) => {
    ...
    const [createProductActive, setCreateProductActive] = useState(false)

    return (
        <div className={cl.modal_wrapper}>
            {createProductActive ?
                <ModalCreateProduct modalChange={setCreateProductActive}/>
                :
                ''
            }
            <div className={cl.modal} onClick={e => e.stopPropagation()}>
                ...
                <div className={optionStyle.join(' ')}>
                    ...
                    <div>
                        <ActionButton style={{width: '100%'}} onClick={() => setCreateProductActive(true)}>
                            Добавить продукт
                        </ActionButton>
                    </div>
                </div>
                        ...
                        <div className={cl.modal_content_inner}>
                            {Products.items ?
                                Products.items.map(item =>
                                    <ModalItemSelect item={item} key={item.id}/>
                                )
                                :
                                ''
                            }
                ...
                <div className={cl.modal_footer}>
                    <div>
                        <ActionButton style={{marginLeft: 10}} onClick={() => Options.setModalActive(false)}>
                            Закрыть
                        </ActionButton>
                    </div>
                    <div>
...
export default observer(StoreModalProducts);